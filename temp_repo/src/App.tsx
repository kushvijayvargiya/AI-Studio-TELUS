            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 bg-bg-secondary/95 backdrop-blur-md rounded-2xl shadow-[0_20px_50px_rgba(75,40,109,0.15)] border border-border-primary py-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-[110] translate-y-2 group-hover:translate-y-0">
                  ...
                  <button onClick={() => { setActiveCustomer(null); setActiveTab('rules'); }} className="w-full text-left px-6 py-3 text-sm font-black text-text-secondary hover:bg-bg-primary hover:text-telus-purple transition-colors border-t border-border-primary/50 mt-1 pt-4">System Rules</button>
                </div>
              </div>
            </div>
          </div>
        ...
        {!activeCustomer && (
          <div className="space-y-16 animate-in fade-in duration-700">
            ...
            <div className="text-center max-w-4xl mx-auto pt-8">
              <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-telus-green/10 text-telus-green text-[10px] font-black uppercase tracking-widest mb-6 border border-telus-green/20">
                <Sparkles className="w-3 h-3 mr-2" />
                AI-Powered Contract Intelligence
              </div>
              <h1 className="text-6xl font-extrabold tracking-tight text-telus-gray sm:text-7xl mb-8 leading-[1.1]">
                ...
                <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[1800px] mx-auto">
                  ...
                  {savedCustomers.length > 0 && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                      <div className="telus-card p-8 flex items-center space-x-6 bg-bg-secondary">
                        ...
                        <div>
                          ...
                          <p className="text-4xl font-black text-white">{savedCustomers.length}</p>
                        </div>
                      </div>
                      <div className="telus-card p-8 flex items-center space-x-6 bg-bg-secondary">
                        ...
                        <div>
                          ...
                          <p className="text-4xl font-black text-white">{totalDocuments}</p>
                        </div>
                      </div>
                      <div className="telus-card p-8 flex items-center space-x-6 bg-bg-secondary">
                        <div className="p-4 bg-bg-primary rounded-2xl text-telus-purple border border-border-primary">
                        ...
                        <div>
                          ...
                          <p className="text-4xl font-black text-white">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(currentMonthRevenue)}</p>
                        </div>
                      </div>
                    </div>
                  )}
